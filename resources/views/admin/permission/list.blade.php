            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Bảng quyền</h6>
                    </div>
                </div>
                        ...
                        <table class="table align-items-center mb-4">
                            <div class="dataTable-top">
                                <div class="dataTable-search">
                                    <form id="searchForm" action="{{ route('permission') }}">
                            ...
                            <thead>
                                <tr>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Quyền
                                    </th>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Mô
                                        tả</th>
                                    <th
                            ...
                            <tbody>
                                @if ($data && !empty($data->items()))
                                    @foreach ($data->items() as $permission)
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">{{ $permission->scope }}</h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="ms-auto text-end d-flex justify-content-around">
                                                    @can('permission.update')
                                                        <a onclick="location.href='{{ route('permission.edit', ['id' => $permission->id]) }}'"
                                                    ...
                                                    @can('permission.delete')
                                                        <form
                                                            ...
                                                            method="POST">
                                                            @csrf
                                                            <button onclick="return confirm('Xóa bản ghi này?');"
