            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Thêm mới vai trò</h6>
                    </div>
                </div>
                            ...
                            <div class="form-group col-6">
                                <div class="input-group input-group-dynamic is-filled">
                                    ...
                                    <input class="multisteps-form__input form-control" type="text" id="name"
                                        name="name" value="{{ old('name') }}" spellcheck="false" autocomplete="off"
                            ...
                            <div class="form-group col-6">
                                <div class="input-group input-group-dynamic is-filled">
                                    ...
                                    <input class="multisteps-form__input form-control" type="text" id="description"
                                        name="description" value="{{ old('description') }}" spellcheck="false"
