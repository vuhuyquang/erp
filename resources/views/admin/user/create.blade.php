                            ...
                            <div class="form-group col-6">
                                <div class="input-group input-group-dynamic is-filled">
                                    ...
                                    <input class="multisteps-form__input form-control" type="text" id="username"
                                        name="username" value="{{ old('username') }}" spellcheck="false" autocomplete="off"
                            ...
                            <div class="form-group col-6">
                                <div class="input-group input-group-dynamic is-filled">
                                    ...
                                    <input class="multisteps-form__input form-control" type="text" id="fullname"
                                        name="fullname" value="{{ old('fullname') }}" spellcheck="false" autocomplete="off"
                                        onfocus="focused(this)" onfocusout="defocused(this)">
                                </div>
                                @error('fullname')
                                    <small class="help-block">{{ $message }}</small>
                            ...
                            <div class="form-group col-4">
                                <div class="input-group input-group-dynamic is-filled">
                                    ...
                                    <input class="multisteps-form__input form-control" type="text" id="email"
                                        name="email" value="{{ old('email') }}" spellcheck="false" autocomplete="off"
                                        onfocus="focused(this)" onfocusout="defocused(this)">
                                </div>
                                @error('email')
                                    <small class="help-block">{{ $message }}</small>
                            ...
                            <div class="form-group col-4">
                                <div class="input-group input-group-dynamic is-filled">
                                    ...
                                    <select class="form-control" style="height: 40.2px;" id="status" name="status"
                                        ...
                                        <option value="0">Đang tạm khóa</option>
                                    </select>
                                </div>
                                @error('status')
                                    <small class="help-block">{{ $message }}</small>
